...
\noindent\href{mailto:joeycyhsiao@gmail.com}{joeyhsiao@gmail.com}\bull % Your email address
...
172 Jiande St., East Dist., Taichung City, Taiwan 40148 
...
Computer-Mediated Communication, Computer-Supported Cooperative Work, Crowd Sourcing,
Intelligent User Interface, Innovative User Interface, Ubiquitous Computing
...
{\href{http://www.ntu.edu.tw}{National Taiwan University}, Taipei, Taiwan}
{Sep '10 -- Jun '13} 
...
\headedsection % Employer name which can include a hyperlink and location/URL on the right side of the page
{\href{http://www.cmu.edu/silicon-valley/}{Carnegie Mellon University Silicon Valley}, Moffett Field, CA, USA}
{Jul '12 -- Sep '12} 
{\headedsubsection % Job title entry for the current employer
	{Visiting Student}
	{}
...
\spacedhrule{0em}{-1em} % Horizontal rule - the first bracket is whitespace before and the second is after
