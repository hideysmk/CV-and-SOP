...
%Applying For: Ph.D. in Information Science, Fall 2015, Cornell University
%Applying For: Ph.D. in Information, Fall 2015, University of Michigan
%Applying For: Ph.D. in Human-Computer Interaction, Fall 2015, Carnegie Mellon University
...
Main: Human-Computer Interaction (\acr{HCI}), Social Computing 
...
{Taipei, Taiwan}
{
	...
	{Jun '12} 
	{\bodytext{Recognizes student for leadership and active participation in department affairs of master students '11}}

	\headedsubsection % Job title entry for the current employer
	{Grade Representative}
	{Sep '07 -- Jun '08} 
	{\bodytext{Recognizes student for leadership and active participation in department affairs of undergraduate '07}}
...
{Taipei, Taiwan}{
	\headedsubsection
	{Workshop Organizing Facilitator}
	{Mar '01 -- Present}
	{\bodytext{Organize the collaborative workshop on design thinking of Stanford d.school and National Taiwan Univ.}}
	\headedsubsection
	{Research Assistant}
	{Jul '14 -- Present}
	{\bodytext{Carry out research on user experience and natural user interface under smart environment
			   as the only M.S. member in the team}}
}
...
{Hsinchu, Taiwan}{
	...
	{Jul '14 -- Present}
	{\bodytext{Conduct research on friendsourcing, and lead a project of devloping a social-driven proofreading system}}
}
...
{Taoyuan, Taiwan}{
	...
	{Jun '14 -- Jul '14}
	{\bodytext{Manage a project of revising military online human resources system in a 4-member team}}
